...
function preload() {
    ...
    // load sound
    msgSent = loadSound("coolKidChatFiles/audio/sentMessage.mp3");
    msgReceived = loadSound("coolKidChatFiles/audio/newMessage.mp3");
...
function receiveMsg(data) {
    ...
    for (i = 0; i < textBox.length; i++) {
        textBox[i].position(20, textBox.length * 30 - (i + 1)*30 + 240);
    }
}
